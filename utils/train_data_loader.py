...
from monai.transforms import LoadImaged, SpatialPadd, Compose, RandScaleIntensityd, \
    RandShiftIntensityd, Rand3DElasticd, RandAxisFlipd, MapLabelValued, AddChanneld, \
