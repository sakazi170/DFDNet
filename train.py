...
from models.DFDNetworks import (base, base_EMF, base_ECB, base_ECB_EMF,
                               base_EMF_EFA, base_ECB_EMF_EFA, base_BIG, base_ECB_small,
                               base_without_bNeck, base_MAX, base_ECB_wo_evi, base_EMF_wo_entropy, base_MAX_EMF)
...
def parse_args():
    ...
    #parser.add_argument('--root', default="/home/zrway/qazisami/dataset/BraTS2020/MICCAI_BraTS2020_TrainingData", help='dataset path')
...
def main():
    ...
    print(f'Mixed Precision - {is_mixed};  CUDNN Benchmark - {benchmark};  GPU ID - {gpu_id};  Batch Size - {batch_size};  Workers - {num_workers}')
...
#======================== Training Loop ==================================================
    ...
    for epoch in range(start_epoch + 1, num_epochs + 1):
        ...
        if epoch % 10 == 0:
            ...
            checkpoint_name = f'{model_name}_{epoch}_loss_{final_avg_loss:.4f}.pkl'
